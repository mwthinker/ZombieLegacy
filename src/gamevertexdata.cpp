#include "gamevertexdata.h"

namespace zombie {

	void GameVertexData::addSquareTRIANGLES(
		float x, float y,
		float w, float h,
	...
	void GameVertexData::addSquareTRIANGLES(float x, float y, float w, float h, const mw::Sprite& sprite, const mw::Color& color) {
	...
	void GameVertexData::addSquareTRIANGLES(float x1, float y1,
		float x2, float y2,
		float x3, float y3,
		float x4, float y4,
	...
	void GameVertexData::addVertex(float x, float y, float xTex, float yTex, bool isTex, const mw::Color& color) {
		VertexData::addVertex<9>({x, y, xTex, yTex, (float) isTex, color.red_, color.green_, color.blue_, color.alpha_});
	}

	void GameVertexData::updateVertex(float x, float y) {
		VertexData::updateVertex(0, x);
		VertexData::updateVertex(1, y);
		nextVertex();
	}

	void GameVertexData::addTriangleTRIANGLES(
		float x1, float y1,
		float x2, float y2,
		float x3, float y3,
	...
	void GameVertexData::updateTriangleTRIANGLES(
		float x1, float y1,
		float x2, float y2,
		float x3, float y3) {
	...
	void GameVertexData::updateSquareTRIANGLES(float x, float y, float w, float h) {
		// Left triangle |_
